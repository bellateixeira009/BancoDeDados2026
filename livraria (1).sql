...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Jun-2026 às 17:15
...
(10, 'Python para Todos', 'Charles Severance', '95.00', 20, 1);
...
--
ALTER TABLE `livros`
  ADD CONSTRAINT `livros_ibfk_1` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id_categoria`);
COMMIT;
